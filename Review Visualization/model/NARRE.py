...
class NARRE(object):
    def __init__(
        ...
        with tf.name_scope("attention"):
            ...
            #self.u_a = tf.ones(tf.shape(self.u_a))
            #self.u_a = tf.math.l2_normalize(self.u_a, axis=1)
            ...
            #self.i_a = tf.ones(tf.shape(self.i_a))
            #self.i_a = tf.math.l2_normalize(self.i_a, axis=1)
